...
if (isset($_POST['User_ID']) and isset($_POST['Name']) and isset($_POST['Type']) and isset($_POST['MaxPrice']) and isset($_POST['AvailableAfter']) and isset($_POST['AvailableUntil'])) {
    ...
    if($x = $_POST['MaxPrice'] != ""){
      if($flag)
        $where2 .= " AND ";
      $where2 .= "Item_Price <= ";
      $where2 .= $_POST['MaxPrice'];
      $flag = 1;
    }
    if($x = $_POST['AvailableAfter'] != ""){
      if($flag)
        $where2 .= " AND ";
      $where2 .= "((Start_Hour > End_Hour AND (Start_Hour <= ";
      $where2 .= $_POST['AvailableAfter'];
      $where2 .= " OR End_Hour >= ";
      $where2 .= $_POST['AvailableAfter'];
    ...
    if($x = $_POST['AvailableUntil'] != ""){
      if($flag)
        $where2 .= " AND ";
      $where2 .= "((Start_Hour > End_Hour AND (Start_Hour <= ";
      $where2 .= $_POST['AvailableUntil'];
      $where2 .= " OR End_Hour >= ";
      $where2 .= $_POST['AvailableUntil'];
      $where2 .= ")) OR (Start_Hour <= End_Hour AND (Start_Hour <= ";
      $where2 .= $_POST['AvailableUntil'];
